...
public class CircleImageViewFragment extends BaseCaseFragment {
    ...
    @BindView(R.id.ui_activity_widget_circle_iamgeview_image)
    public ImageView imageView;
    @BindView(R.id.ui_activity_widget_circle_iamgeview_image_alpha)
    public ImageView imageViewAlpha;
    @BindView(R.id.ui_activity_widget_circle_iamgeview_text)
