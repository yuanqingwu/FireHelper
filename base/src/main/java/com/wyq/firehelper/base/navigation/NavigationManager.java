package com.wyq.firehelper.base.navigation;
...
public class NavigationManager {
    ...
    public static final String NAVIGATION_DEVICE_MAIN_ACTIVITY = "/device/DeviceActivity";
    public static final String NAVIGATION_UI_MAIN_ACTIVITY = "/ui/UiMainActivity";
    public static final String NAVIGATION_SECURITY_MAIN_ACTIVITY = "/security/SecurityActivity";
    ...
    /**
     * 通过ARoute跳转到webview的url参数
     */
    public static final String NAVIGATION_KEY_ARTICLE_URL = "url";
}
