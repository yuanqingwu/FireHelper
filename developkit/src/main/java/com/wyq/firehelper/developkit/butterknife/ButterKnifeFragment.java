...
public class ButterKnifeFragment extends BaseCaseFragment {
    ...
    @BindView(R2.id.activity_developkit_butterknife_tv_2)
    public TextView textView2;

    @BindView(R2.id.activity_developkit_butterknife_tv_3)
    public TextView textView3;

    @BindView(R2.id.activity_developkit_butterknife_tv_4)
    public TextView textView4;

    @BindView(R2.id.activity_developkit_butterknife_tv_5)
